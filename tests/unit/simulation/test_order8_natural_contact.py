...
def _valid_report(env: Order8IsaacNaturalContactEnv, graph) -> dict:
    ...
    monitor_result = Order8NaturalContactResult(
        ...
        cumulative_tangential_slip_m_by_link={
    ...
    return {
        ...
        "order8_natural_contact_contact_mesh_precenter_complete": True,
        "order8_natural_contact_contact_mesh_precenter_dwell_s": (
            env.config.contact_stall_dwell_s
        ),
        "order8_natural_contact_contact_mesh_precenter_completed_time_s": 1.0,
        ...
        "order8_natural_contact_contact_closure_reason": (
            "dynamic_simultaneous_surface_region_arrest"
        ),
        ...
        "order8_natural_contact_dock_actuator_telemetry_maxima": {
            ...
            "abs_requested_unclipped_torque_bias_nm": 5.0,
            "abs_requested_limited_torque_bias_nm": 4.1,
            "abs_isaac_effort_target_nm": 4.1,
            "abs_estimated_position_drive_torque_nm": 2.0,
            "abs_estimated_total_drive_torque_nm": 5.0,
            "abs_isaac_computed_torque_nm": 4.1,

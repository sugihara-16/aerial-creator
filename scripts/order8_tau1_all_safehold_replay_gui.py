...
"""Low-load GUI replay for the 50 s, +/-1 Nm, no-safe-hold diagnostic."""
...
SOURCE_REPORT = REPO_ROOT / (
    ...
    "cone_proxy_pad_tau1_all_safehold_v378_50s.json"
)
TRACE_PATH = REPO_ROOT / (
    "artifacts/p4_full/order8_natural_contact/diagnostics/"
    "cone_proxy_pad_tau1_all_safehold_v378_50s_state_trace.json"
)

...
class NaturalContactPlannerConfig:
    horizon_s: float = 1.0
    knot_dt_s: float = 0.1
    # TRANSPORT alone requires 0.20 m at a bounded 0.01 m/s in the formal
    # natural-contact path, so a 15 s generic phase timeout is unreachable by
    # construction.  Thirty seconds preserves a finite failure bound while
    # allowing rate-limited motion plus tracking/dwell margin.

    ...
    def build_archive(
        ...
        return EpisodeArchive(
            ...
            rollout_artifacts={
                ...
                "p4_2_release_events": [event.to_dict() for event in rollout_result.release_events],
...
def _case_metrics(
    ...
    metrics = {
        **rollout_result.metrics,
        ...
        "release_event_count": float(len(rollout_result.release_events)),
        ...
        "p4_4_natural_contact_grasp_remaining": 1.0,
